...
import Table, { AvatarCell, PlayPill, SelectColumnFilter, StatusPill } from './Table'  // new
...
function Tab() {
 ...
 let res;
 let url='http://localhost:8085/engine-rest/task';
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900">
      ...
      {/* <Alert color="red" msg="ok"/> */}
        ...
        <div className="mt-6">
          <Table columns={columns} data={allTask} />
        </div>
      </main>
