    ...
    <div>
      {props.color=="green" && (
        ...
        >
          ...
          <div>
            <span class="font-medium">Success alert!</span> {props.msg}
          </div>
        </div>
      )}
      {props.color=="yellow" && (
        ...
        >
          ...
          <span class="sr-only">Info</span>
          <div>
            <span class="font-medium">Warning alert!</span> {props.msg}
          </div>
        </div>
      )}
      {props.color=="red" && (
        ...
        >
          ...
          <span class="sr-only">Info</span>
          <div>
            <span class="font-medium">Danger alert!</span> {props.msg}
          </div>
        </div>
      )}
    </div>
